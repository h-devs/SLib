...
namespace slib
{
	namespace string
	{
		...
		SLIB_DEFINE_STRING_RESOURCE_BEGIN(close, "Close")
			SLIB_DEFINE_STRING_RESOURCE_VALUE(ko, "\xeb\x8b\xab\xea\xb8\xb0")
		SLIB_DEFINE_STRING_RESOURCE_END

		SLIB_DEFINE_STRING_RESOURCE_BEGIN(copy, "Copy")
			SLIB_DEFINE_STRING_RESOURCE_VALUE(ko, "\xeb\xb3\xb5\xec\x82\xac")
		SLIB_DEFINE_STRING_RESOURCE_END
		...
		SLIB_DEFINE_STRING_RESOURCE_BEGIN(open, "Open")
			SLIB_DEFINE_STRING_RESOURCE_VALUE(ko, "\xec\x97\xb4\xea\xb8\xb0")
		SLIB_DEFINE_STRING_RESOURCE_END
		...
		SLIB_DEFINE_STRING_RESOURCE_BEGIN(reply, "Reply")
			SLIB_DEFINE_STRING_RESOURCE_VALUE(ko, "\xec\x9d\x91\xeb\x8b\xb5")
		SLIB_DEFINE_STRING_RESOURCE_END
		...
		SLIB_DEFINE_STRING_RESOURCE_MAP_BEGIN
			...
			SLIB_DEFINE_STRING_RESOURCE_MAP_ITEM(close)
			SLIB_DEFINE_STRING_RESOURCE_MAP_ITEM(copy)
			...
			SLIB_DEFINE_STRING_RESOURCE_MAP_ITEM(open)
